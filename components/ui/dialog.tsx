...
function DialogOverlay({
  ...
  return (
    // Note: Radix Dialog only renders its Overlay in modal mode.
    // We render a plain overlay div so the blurred backdrop also works in non-modal (e.g. iframe/embed) usage.
    <div
